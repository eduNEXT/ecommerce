...
from ecommerce.extensions.payment.processors.payu import PayU # MH
...
Order = get_model('order', 'Order')# MH
...
'''
# MH
class PayuProfileAdminView(View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(PayuProfileAdminView, self).dispatch(request, *args, **kwargs)
